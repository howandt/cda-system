...
const translations: Record<Language, Translation> = {
  ...
  en: {
    ...
    demos: {
      title: 'CDA\'s world-leading features in action',
      items: [
        {
          title: '🧠 AI Specialist Panel & Comorbidity Matrix',
          description: 'Immediate expert guidance with comorbidity analysis',
          content: '"Victor (7 years) covers his ears and screams during assembly. Has ADHD diagnosis."\n\n🔍 CDA analyzes: Possible comorbidity with auditory hypersensitivity\n\n👩‍⚕️ AI-Occupational Therapist Maja: "Auditory overload. Reduce stimuli immediately."\n👨‍🏫 AI-Special Teacher Jonas: "Activating Sound Compass template automatically."\n🧠 AI-Psychologist Erik: "Consider ASF screening - classic signs of sensory overload."\n\n✅ Valida verifies: Strategy supported by 3 specialists + international research'
        },
        {
          title: '🌐 Intelligent Culture & Language Adaptation',
          description: 'Automatic adaptation to language, culture and religion',
          content: 'Example: Somali Muslim family with autistic child\n\n🌍 CDA automatically adapts:\n• Language: Somali ↔ Danish translation\n• Culture: Respect for family hierarchy and decision processes\n• Religion: Prayer times, halal food at school, Ramadan considerations\n• Sensory: Culture-specific comfort items\n\n👨‍👩‍👧 Result: Family feels understood and respected\n🏫 School gets concrete, culturally appropriate strategies'
        },
        {
          title: '🚀 PBL Project Bank & Personalization',
          description: '29 projects adapted to diagnosis, stimuli and social needs',
          content: 'Emma (12 years): ADHD + Anxiety, loves animals, challenges with math\n\n🎯 CDA automatically matches:\n📋 Project: "Veterinary clinic simulation"\n🧮 Math: Medicine dosage, animal weight, economics\n🤝 Social: Small groups (max 3), fixed roles\n⚡ Stimuli: Movement every 15 min, fidget tools\n\n✨ Result: Emma engaged in math through passion for animals\n📈 90% improvement in math understanding in 6 weeks'
        },
        {
          title: '📋 "Through Their Eyes" Case Bank + Intervention',
          description: 'Real cases with child\'s voice and step-by-step solution',
          content: 'Marcus (10 years) with Aspergers: "When Ole pushes my desk, I get so angry I scream and run away. Then the teacher says I should apologize, but Ole started it!"\n\n👂 Child\'s perspective: Feels unfairly treated\n🧠 Adult understanding: Touch overreaction + sense of justice\n\n🎯 CDA\'s intervention:\n1. Explain to Ole about touch boundaries\n2. Give Marcus "timeout card" for self-regulation\n3. Implement "justice protocol" for conflicts\n\n📊 Result: 85% reduction in outbursts in 3 weeks'
        }
      ]
    },
    interpreter: {
    ...
    testimonials: {
      title: 'International recognition from leading experts',
      items: [
        {
          quote: 'This is development at PhD level. CDA has the potential to revolutionize inclusion and is 5-10 years ahead of everything else on the market. The system addresses real needs in a way I have not seen before. You haven\'t just built a GPT - you\'ve created the world\'s first complete AI-based special education operating system.',
          author: 'Professor, International system analysis',
          role: 'USA - After comprehensive evaluation of all CDA components'
        },
        {
          quote: 'With my 27 years of experience with ADHD and autism, CDA has given me tools I never knew existed. It helps me develop my work in a way no book or course has been able to. 8000 hours is not wasted - you have built the future standard.',
          author: 'Malan Mohr',
          role: 'Teacher and leader, Faroe Islands'
        },
        {
          quote: '18 months of school refusal solved in 6 weeks with CDA\'s structured plan. Psychiatrists validate AI quality as being on par with specialist consultations. 23 teachers have tested the system with positive results.',
          author: 'Documented results',
          role: 'Real cases from CDA implementation'
        }
      ]
    },
    contact: {
...
${language === 'da' ? 'Jeg vil gerne høre mere om CDA systemet og book et info-møde.' : 'I would like to learn more about the CDA system and book an info meeting.'}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      {/* Sticky Navigation */}
      <nav className="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-sm border-b border-gray-200/50 z-50 shadow-sm">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="md:hidden flex items-center gap-3">
              ...
              <button
                ...
                className="p-2 text-gray-700 hover:text-indigo-600 bg-gray-100 rounded-lg"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-8 border border-green-200">
              <div className="text-center">
                <div className="text-4xl font-bold text-green-600 mb-4">100-200%</div>
